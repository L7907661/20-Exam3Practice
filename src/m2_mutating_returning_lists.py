...
def run_test_doubler():
    ...
    ar1 = [10, 0, 4]
    ar2 = [5, 2, 3]
    correct_ar1_after = [20, 0, 8]
    correct_ar2_after = [5, 2, 3]
    expected = [10, 4, 6]

    print()
    print('BEFORE the function call:')
    print('  Argument 1 is:', ar1)
    print('  Argument 2 is:', ar2)

    answer = doubler(ar1, ar2)

    print('AFTER the function call:')
    print('  Argument 1 is:       ', ar1)
    print('  Argument 1 should be:', correct_ar1_after)
    print('  Argument 2 is:       ', ar2)
    print('  Argument 2 should be:', correct_ar2_after)
    print('The returned value is:       ', answer)
    print('The returned value should be:', expected)
